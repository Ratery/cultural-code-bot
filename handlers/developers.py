...
async def cmd_developers(message: types.Message) -> None:
    await message.answer(
        text=clean_msg(
            ...
            Если Вы являетесь учеником 9 класса лицея им. Н. И. Лобачевского и заинтересованы в дальнейшем развитии проекта в рамках индивидульной проектной деятельности на протяжении 10 класса, свяжитесь с <b><a href="https://t.me/TheRatery">Ratery</a></b>.
